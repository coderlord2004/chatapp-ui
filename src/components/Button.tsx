...
const Button = () => {
	return (
		<Link
			...
			style={{
				WebkitBoxReflect:
					'below 0px linear-gradient(to bottom, rgba(0,0,0,0.0), rgba(0,0,0,0.2))',
				boxShadow:
					'0 20px 25px -5px rgba(59, 130, 246, 0.3), 0 8px 10px -6px rgba(59, 130, 246, 0.3)',
			}}
			className="group relative z-10 block h-[100px] w-[300px] translate-x-[50%] transform cursor-pointer overflow-hidden rounded-full bg-gradient-to-r from-blue-500 to-purple-500 px-10 py-3 text-center tracking-widest text-transparent transition-shadow duration-500 ease-out after:absolute after:top-1/2 after:left-1/2 after:h-[85%] after:w-[95%] after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-full after:bg-blue-50 hover:shadow-[0_35px_60px_-15px_rgba(59,130,246,0.5)] hover:saturate-[1.15] active:saturate-[1.4]"
		>
			<p className="absolute top-1/2 left-1/2 z-40 h-full w-full -translate-x-1/2 -translate-y-[30%] bg-gradient-to-r from-black to-gray-800 bg-clip-text text-2xl font-semibold tracking-widest text-transparent transition-all duration-400 group-hover:-translate-y-full">
				Tính năng mới
			</p>
			<p className="absolute top-1/2 left-1/2 z-40 h-full w-full -translate-x-1/2 translate-y-full bg-gradient-to-r from-black to-gray-800 bg-clip-text text-2xl font-semibold tracking-widest text-transparent transition-all duration-400 group-hover:-translate-y-[40%] group-hover:text-[120%]">
				Mạng xã hội <span className="text-white">Nextvibes</span>
			</p>

			<svg
				className="absolute top-1/2 left-1/2 z-30 h-full w-full -translate-x-1/2 -translate-y-1/2 scale-x-125 rotate-180 animate-pulse transition-all duration-300 group-hover:-translate-y-[45%] group-hover:animate-none"
			...
			>
				<defs>
					<linearGradient
						...
						x1="50%"
					>
						<stop offset="0%" stopOpacity={1} stopColor="hsl(210, 100%, 60%)" />
						<stop
							offset="100%"
							stopOpacity={1}
			...
			<svg
				className="absolute top-1/2 left-1/2 z-40 h-full w-full -translate-x-1/2 -translate-y-[30%] fill-blue-500 transition-all duration-500 group-hover:-translate-y-[33%] group-hover:scale-95"
