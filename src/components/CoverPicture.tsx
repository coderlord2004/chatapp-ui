...
export default function CoverPicture({ src }: Props) {
	return (
		<div className="relative h-64 w-full overflow-hidden md:h-80">
			...
			<div className="group absolute right-4 bottom-4 flex cursor-pointer items-center justify-center rounded-full bg-white/80 p-2.5 backdrop-blur-sm transition-all duration-300 hover:bg-white dark:bg-gray-800/80 dark:hover:bg-gray-700">
